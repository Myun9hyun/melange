    ...
    #         st.write("검색어를 입력하면 결과가 표시됩니다.")
        ...
        artworks = {
            ...
            "해바라기꽃길": {
                "작가" : "김두식",
                "호수" : "30호",
                "설명" : "양수리 두물머리의 꽃길을 자전거타고 가는 연인을 보며 그린 풍경화 해바라기꽃길을 따라 강물을 보며 여유를 찾고 일상의 행복을 찾는 사람들을 보며 작가는 삶의 행복이 멀리 있지 않다는 것을 그림으로 깨닫게 합니다. 일상의 편안함과 여유를 갖고 있다면 마음도 부유해지고 삶의 질도 윤택해진다고 생각하는 작가의 마음을 내포하고 있는작품 해바라기꽃 태양을 닮은 꽃으로 황금과 명예를 불러오는 꽃입니다",
                "이미지" : "Cozem/yoon_pictures/해바라기꽃길.jpeg",
                "크기(가로X세로)" : "90X44.5",
                "매체" : "",
            },
            "봄": {
                "작가" : "김광남",
                "호수" : "12호",
                "설명" : "작은 점으로 표현하는 점묘기법 배경의 채색이 이색적인 작품입니다. 자연속에서 꽃으로 바구니를 만들어 머리에 올리고 양들이 나와서 먹이를 먹고있는 모습이 겨울이 지나 봄이 오는 모습을 그린 희망적인 의미의 작품입니다. 사계절중에 봄은 시작을 의미하고 희망을 상징하는 계절입니다. 봄의 소리를 그림으로 표현한 추상적인 작품입니다",
                "이미지" : "Cozem/yoon_pictures/봄.jpeg",
                "크기(가로X세로)" : "59.5X49.5",
                "매체" : "",
            },
            "소풍같은하루": {
                "작가" : "김길상",
                "호수" : "",
                "설명" : "바이올린 연주소리가 들리는 오후에 골프를 즐기는 사람들과 바다위로 항해하는 배 꽃밭에 피어난 초록잎 참새들 자연의 모든풍경과 여유롭게 운동하는 사람모두 이상향을 동경하고 꿈꾸는 작가의 따뜻한 사람사는 세상을 그린 작품",
                "이미지" : "Cozem/yoon_pictures/소풍같은하루.jpeg",
                "크기(가로X세로)" : "52.5X40.5",
                "매체" : "캔버스(유화, 돌가루, 석채)",
            },
            "해바라기&석류": {
                "작가" : "박명진",
                "호수" : "10호",
                "설명" : "박명진 작가 고유의 작품기법은 물감의 질감이 엄청 두껍고 화려한 색채감은 실제 모습을 사진으로 담을 수 없을 만큼 신비롭습니다. 작업기간이 1작품당 1달이 넘는 긴 시간동안 어렵게 그려진 그림인 만큼 작품의 깊이가 느껴지는 그림입니다. 해바라기 태양을 닮을꽃으로 꽃잎이 황금색을 띠고 씨앗이 무수히 많은 꽃으 로 황금과 재물을 불러오는꽃입니다. Impasto. '반죽된'이란 뜻을 가진 이탈리아어 유화(미술)의 기법입니다. 물감을 두텁게 바르는 방식으로 그림을 그리는 것을 뜻하는데, 붓이나 나이프, 손 등으로 물감을 떠서 주로 중요한 부위를 강조하는 기법입니다.",
                "이미지" : "Cozem/yoon_pictures/해바라기&석류.jpeg",
                "크기(가로X세로)" : "53X45.5",
                "매체" : "",
            },
            "빨강사과상자": {
                "작가" : "정서우",
                "호수" : "30호",
                "설명" : "빨강사과는 계약의 성공 / 사업의 추진하는일의 결실또는 성과를 의미합니다. 상자속에 가득찬 사과는 수많은 계약을 성공하고 이룬다는 뜻을 담고있습니다. 작은 세필붓으로 사과의 싱그러움과 붉은 사과의 탐스러움을 자연그대로 생생하게 손수 그린 사과작품의 오랜 30년이상의 작품활동을하신 정서우 작가의 작품입니다",
                "이미지" : "Cozem/yoon_pictures/빨강사과상자.jpeg",
                "크기(가로X세로)" : "90X45",
                "매체" : "캔버스(유화), 극사실화",
            },
        ...
        if options == '윤아트갤러리':
            st.title("윤아트갤러리 작품 아카이브🎨")
            st.write("윤아트갤러리 작품 목록입니다")
            option = st.selectbox(
                '원하는 작품을 골라주세요',
                tuple(artworks.keys())
            )
